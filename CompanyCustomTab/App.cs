...
namespace SERATools
{
    ...
    {
        static AddInId appId = new AddInId(new Guid("4EF8B62C-49DD-4B6A-BAA8-FBBD44B51F46"));
        ...
        private void AddRibbon(UIControlledApplication app)
        {
            ...
            btnWebsite1.LargeImage = GetEmbeddedImage("CompanyCustomTab.Images.PS32.png");
            btnWebsite1.Image = GetEmbeddedImage("CompanyCustomTab.Images.PS16.png");
